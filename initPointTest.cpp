...
int main() {
    // precondition: p1, p2, p3, p4 are 4 empty pointers
    // p1Expected, p2Expected, p3Expected, p4Expected are also 4 empty pointers
    // Post condition: input values for the 8 Pointers are set
    // p1, p2, p3, p4 are passed through function pointsApproxEqual
    // with p1Expected, p2Expected, p3Expected, and p4Expected respectively
    // Passes if it is true.
